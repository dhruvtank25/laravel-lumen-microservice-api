    ...
    public function newOrderList(Request $request)
    {
        try {
            ...
            if ($credentials) {
                ...
                $new_order_list = Orders::getNewOrderList($input['vendor_id']);
                return ResponseBuilder::responseResult($this->successStatus, 'New Order List has been fetched successfully',$new_order_list);
            } else {
